...
//let chars = [0x25E0, 0x25E1, 0x203F, 0x2054];
let chars = [
...
let tally = Object.fromEntries(chars.map((cp, i) => [SPEC.format(cp), buckets[i].length]))
...
console.log(JSON.stringify(Object.fromEntries(chars.map((cp, i) => [SPEC.format(cp), buckets[i]])), null, '\t'));