...
IMPLS.push({
	name: 'Reference', 
	fn: reference, 
	version: await read_package_version(`@adraffy/ens-norm-ref-impl`)
});
...
IMPLS.push({
	name: 'ens_normalize', 
	fn: ens_normalize, 
	version: await read_package_version(`@adraffy/ens-normalize`)
});

// ********************************************************************************

import {create_uts46} from '@adraffy/ens-norm-uts46';
const UTS46_VERSION = await read_package_version(`@adraffy/ens-norm-uts46`);
